...
<!-- Mirrored from swin-themes.com/html/fooday/product-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Sep 2017 09:23:26 GMT -->
<head>
    <meta charset="UTF-8">
          ...
          <div data-bottom-top="background-position: 50% 50px;" data-center="background-position: 50% 0px;" data-top-bottom="background-position: 50% -50px;" class="page-title page-product">
            <div class="container">
              <div class="title-wrapper">
                <div data-top="transform: translateY(0px);opacity:1;" data--20-top="transform: translateY(-5px);" data--50-top="transform: translateY(-15px);opacity:0.8;" data--120-top="transform: translateY(-30px);opacity:0;" data-anchor-target=".page-title" class="title">Món Ăn</div>
 ...
 <?php
                        $id=$_GET['id'];
                        $monan=chitietmonan($id);
                        $row_chitiet=mysqli_fetch_array($monan);
                        ?>

                            <div class="featured-image-item"><img style="width:345px;height:233px" src="assets/images/hinh_mon_an/<?php echo $row_chitiet['image'] ?>" alt="fooday" class="img img-responsive"></div>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="product-summary">
                      <div class="product-title">
                        <div class="title"><?php echo $row_chitiet['name'] ?></div>
                      </div>
                      <div class="product-price">
                        <div class="price"><?php echo $row_chitiet['price'] ?><span class="currency-symbol">vnđ</span></div>
                      </div>
                      <div class="product-desc">
                        <p><?php echo $row_chitiet['detail'] ?></p>
                      </div>
...
$monancungloai=monancungloai($id_type);
while ($row_monancungloai=mysqli_fetch_array($monancungloai)) 
{
?>

                    <div class="blog-item item swin-transition">
                      <div class="block-img"><img style="width:345px;height:233px" src="assets/images/hinh_mon_an/<?php echo $row_monancungloai['image'] ?>" alt="" class="img img-responsive">
                        <div class="block-circle price-wrapper"><span class="price woocommerce-Price-amount amount"><span class="price-symbol">$</span><?php echo $row_monancungloai['price'] ?></span></div>
                      ...
                      <div class="block-content">
                        <h5 class="title"><a href="chi-tiet-mon-an.php?c=chitietmonan&id=<?php echo $row_monancungloai['id']?>&id_type=<?php echo $row_monancungloai['id_type']?>"><?php echo $row_monancungloai['name'] ?></a></h5>
                      </div>
                    </div>
<?php 
 } 
...
<!-- Mirrored from swin-themes.com/html/fooday/product-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Sep 2017 09:23:39 GMT -->
</html>