...
<!-- Mirrored from swin-themes.com/html/fooday/menu-grid-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Sep 2017 09:23:03 GMT -->
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Món ăn theo mùa</title>
    <!-- Bootstrap CSS-->
            ...
            <div class="container">
              <div class="topbar-left">
                <div class="topbar-content">
                  <div class="item"> 
                    <div class="wg-contact"><i class="fa fa-map-marker"></i><span>180 Cao Lỗ,Phường 4, Quận 8</span></div>
                  </div>
                  <div class="item"> 
                    <div class="wg-contact"><i class="fa fa-phone"></i><span>...</span></div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="row ">
                    <label class="col-md-6 col-md-offset-3">Nhập tên món/mô tả/đơn giá:
                      <form action="" method="get" accept-charset="utf-8">
                        <input type="text" value="" name='tim' class="form-control">
...
<?php 
$tukhoa=$_GET['tim'];
$monan=timkiem($tukhoa);
while($row_monan=mysqli_fetch_array($monan))
{
 ?>
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="blog-item item swin-transition">
                          <div class="block-img"><img style="width:345px;height:233px" src="assets/images/hinh_mon_an/<?php echo $row_monan['image'] ?>" alt="" class="img img-responsive">
                            <div class="block-circle price-wrapper"><span class="price woocommerce-Price-amount amount"><span class="price-symbol">$</span><?php echo $row_monan['price'] ?></span></div>
                          ...
                          <div class="block-content">
                            <h5 class="title"><a href="chi-tiet-mon-an.php?c=chitietmonan&id=<?php echo $row_monan['id']?>&id_type=<?php echo $row_monan['id_type']?>"><?php echo $row_monan['name'] ?></a></h5>
                            <div class="product-info">
                             <?php echo $row_monan['summary'] ?>
                            </div>
                          </div>
                        </div>
                      </div>
...
<!-- Mirrored from swin-themes.com/html/fooday/menu-grid-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Sep 2017 09:23:09 GMT -->
</html>