      ...
      <div id="html-content" class="wrapper-content">
              ...
              <nav id="main-nav-offcanvas" class="main-nav-wrapper">
                ...
                <div class="main-nav">
                  <ul id="main-nav" class="nav nav-pills">
                    ...
                    <li><a href="tim-kiem.php?p=timkiem&tim=">Tìm kiếm</a></li>
                    <li><a href="about.php">Giới thiệu</a></li>
                    <li><a href="contact.php">Đăng Nhập</a></li>
                  </ul>
                </div>
              </nav>
            </div>
        ...
        <div class="page-container">
          ...
          <div class="page-content-wrapper">
            ...
            <?php 
            $food=danhsachmonan();
            while ($row_food=mysqli_fetch_array($food)) {
         
            ?>               

                            <div class="item product-01">
                              <div class="item-left"><img src="assets/images/hinh_mon_an/<?php echo $row_food['image'] ?>" alt="" class="img img-responsive">
                                <div class="content-wrapper"><a href="chi-tiet-mon-an.php?p=chitietmonan&id=<?php echo $row_food['id'] ?>&id_type=<?php echo $row_food['id_type'] ?>" class="title"><?php echo $row_food['name'] ?></a>
                                  <div class="dot">...................</div>
                                  <div class="des"><?php echo $row_food['summary'] ?></div>
                                </div>
                              </div>
                              <div class="item-right"><span class="price woocommerce-Price-amount amount"><span class="price-symbol">$</span><?php echo $row_food['price'] ?></span></div>
                            </div>
            ...
            <?php 
            $monan=danhsachmonan();
            while ($row_danhsachmonan=mysqli_fetch_array($monan)) {
            ?>
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="blog-item item swin-transition">
                          <div class="block-img"><img style="width:353px;height: 256px" src="assets/images/hinh_mon_an/<?php echo $row_danhsachmonan['image'] ?>" alt="" class="img img-responsive">
                            <div class="block-circle price-wrapper"><span class="price woocommerce-Price-amount amount"><span class="price-symbol"><?php echo $row_danhsachmonan['price'] ?>$</span></span></div>
                          ...
                          <div class="block-content">
                            <h5 class="title"><a href="chi-tiet-mon-an.php?c=chitietmonan&id=<?php echo $row_danhsachmonan['id'] ?>&id_type=<?php echo $row_danhsachmonan['id_type'] ?>"><?php echo $row_danhsachmonan['name'] ?></a></h5>
                            <div class="product-info">
                              <ul class="list-inline">
                                <li class="author"><span>Chef</span><span class="text">Don Joe</span></li>
                                <?php echo $row_danhsachmonan['summary'] ?>
                              </ul>
                            </div>
                          </div>
                        </div>
